/* ============================================================
   COTIZADOR DE VIVIENDA — Catania Residencial
  ...
  function initCotizador(root, cfg) {
    ...
    if (waBtn) {
      waBtn.addEventListener('click', function () {
        ...
        var msg = [
          'Hola! Me interesa el prototipo *' + (proto.nombre || '') + '* de Catania Residencial.',
          '',
          'Mi simulación:',
    ...
    if (pdfBtn) {
      pdfBtn.addEventListener('click', function () {
        ...
        var html = '<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8">'
          + '<title>Cotización Catania Residencial</title>'
          + '<style>'
          ...
          + '<div style="text-align:right;font-size:12px;color:#6b7280;">Catania Residencial</div>'
          + '</header>'
          + '<table>'
      ...
      if (rvForm) {
        rvForm.addEventListener('submit', function (e) {
          ...
          var fields = [
            ...
            { name: 'que_prototipo_te_interesa_catania', value: proto.nombre || '' }
          ];
